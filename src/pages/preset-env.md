...
**Henry Zhu**: This is the Babel podcast! This is the second episode, six months after the first one with Sebastian. I was going to do one every week, and I guess I got burnt out from all the other podcasts. 

**Jason Miller**: You can do one per year! (laughs)

**Henry Zhu**: I am willing to do a lot more, now that we have more ideas. I was in Boston and I figured I should meet up with Jason. Now we're recording a podcast. We're going to try video! (laughs)
...
**Jason Miller**: Happy to be here. Didn't have to go very far.
...
**Jason Miller**: The backstory is, I work on the Chrome team as a devrel. One of the things that I find myself doing (no idea whether I'm supposed to do this), is combing through traces and bundle analyses of tons of different websites.
...
**Henry Zhu**: The patterns that you're finding. 

**Jason Miller**: Yeah, exactly. 

**Henry Zhu**: This is real world sites.

**Jason Miller**: Right. For me, the things I'm most interested in are symptoms that show up as a result of tools.
...
**Henry Zhu**: Because it is a tool. 

**Jason Miller**: You fix the tool, you fix every configuration that uses it! 
...
**Henry Zhu**: I don't think we think about that as people that work on these projects. You're dealing with like these minutiae, but it's like it does affect a lot. Maybe as a community we've been focusing on the size of individual libraries or frameworks. 

**Jason Miller**: I'm certainly guilty of that. (laughs)

**Henry Zhu**: I guess especially you! Only recently have people gotten together to think about the tooling, like bundling and compilers. So Babel is a good example. Maybe it's like everyone's focusing on reducing that one time cost of the library versus the tools, which everyone is constantly using all the time.

**Jason Miller**: I was thinking about it as like.. I'm terrible at math. The one thing I do remember is like the slope of a line formula

**Henry Zhu**: mx+b?

**Jason Miller**: Yeah y=mx+b. It's easy to focus on that static base cost.
...
**Jason Miller**: Personally, I think there's worth on both sides. But oh man, if you're looking for value, especially if we have this notion that we've underinvested in tooling, then that seems like a huge reason to go and look at that scale factor.

**Henry Zhu**: I would say that it's lacking in the sense that usually there's a lot of activity around frameworks. There's the companies that support them, maybe in some sense own them? Or there's conferences like ReactConf, VueConf. There's no like BabelConf or WebpackConf. I was thinking we should do a ToolConf.

**Jason Miller**: ToolConf. I'd love that. That'd be cool. I know who could be the band that plays at the end.

**Henry Zhu**: Ok (laughs). That makes sense.

**Jason Miller**: Good luck getting them to come. 

**Henry Zhu**: But yeah, we haven't focused on the tools and they just "work". In the majority of cases for something like Babel, you don't have to think about it. There's a point where something goes wrong, and you report the bug.. and no one has any understanding of how these work.
...
**Jason Miller**: Because if you're building something that sits on top of these tools, these are your problems. 

**Henry Zhu**: Right. We don't have ownership over that, cause you just kind of hope that people have good will and are willing to continue to do this.

**Jason Miller**: Maybe we don't.

**Henry Zhu**: Yeah, we do. But life gets in the way, anything could happen. You get health problems, you move, you go to school, you get out of school, you get married, you get kids. All these things happen. We're just relying on a few people to literally work on these things.

**Jason Miller**: The maintainers of the infrastructure. But I think the weirdest part here, is for a gaggle of programmers (you could just look at the programming aspect) these are really interesting problems. So I'm always surprised when people don't 

**Henry Zhu**: Why is it not more people?

**Jason Miller**: Yeah. It's just like nice, meaty, fun, isolated challenges. 

**Henry Zhu**: Right. Is it because they're so far removed from how it works? It's either too daunting or there's just no lack of context that you don't even know what questions to ask. I think one of the most important things I've learned is, how do you ask the right questions? Not literally getting the answers, but just being curious about how things work and getting involved, understanding the people behind the project rather than just using it. Like that's the whole thing, right? That was a good segue.

**Jason Miller**: A good intro.

### Thinking about programming language design

**Henry Zhu**: Hopefully that gives you a sense of the things that we're thinking about.
...
**Jason Miller**: Yeah. Looking at the model that somebody like you might have in their head of what Babel means, not just as a body of code, but as its purpose in the world, it's something more than just like a code transformer, right?
...
**Henry Zhu**: As someone that works on it, my goal is to somehow.. how do you embody those models or values through the culture of the project and the content we put out?
...
**Jason Miller**: Right. Babel, the implementation, is the source code transformer. Babel, the reason for existence, is a democratization of language design. And it sounds grandiose, but that's very literally what the project is for. 

**Henry Zhu**: Yeah. I would admit, I'm not doing the best job of figuring out how to say that. Cause it sounds too weird or what are you talking about?
...
**Jason Miller**: The tooling that underpins JavaScript; Babel's job there is to make that more accessible than other languages. To make the language itself more malleable and easier to reason about to somebody who otherwise might not have gotten involved with AST transformations.

**Henry Zhu**: The "rising tide lifts all boats" analogy. There's that balance because the problem with everyone doing it is the scenario where like you go on GitHub and it's a JS file, but like it's just random stuff.

**Jason Miller**: You just append random letters to the end of JS!

**Henry Zhu**: That'd be funny. Maybe we should try it. And I think that's the experimentation part. But at the same time, we need to make sure that our platform is stable. Maybe it's like science. We allow people to contribute and maybe there are good things that we can take in. How do you make sure that people are experimenting but then not creating bifurcation of all these platforms.

**Jason Miller**: It's like at some point you either need to codify that there exists a meta language level and then a language level and eventually we would like to migrate things to the language level when they prove their worth. Or we need to make that the culture that we have. Like we are all sort of working towards making a better language, but our vector for doing that is making other languages. Making extensions to our language and just recognizing that like these are builds to die.

### Built to Die? preset-env

**Henry Zhu**: I think that the idea of "build to die" is super interesting. Maybe that should be a part of our philosophy as a project itself. I've heard of Brian saying PhoneGap was supposed to be like that.
...
**Jason Miller**: Your system is working as designed because the parameters that you put into it based on your business data. You had agreed to break those older browsers. It wasn't a technology failure. It was a common understanding that you would not choose to support those things. 

**Henry Zhu**: Right. I guess the goal with preset-env is how can we prevent "unneeded compilation"

**Jason Miller**: How do you prevent somebody saying, "I'm going to compile to ECMAScript 5 and then never going back to look at that again"?

**Henry Zhu**: If we want to go from the browser perspective, you work at a company that has a browser. If everyone is using Babel, and there is nothing like preset-env, then there is no real world application of people using native ES6 syntax. So browsers have an incentive to convince Babel to use preset-env.

**Jason Miller**: Absolutely. This actually comes down to the prioritization for somebody who is building a JavaScript engine. It's really difficult to say, "we're going to optimize how fast arrow functions are" if, you know, in the wild, that's 5% of websites. Or would you rather optimize argument's access in sloppy mode because you know, that's 95%. And then it's weird, you have another option at your disposal there, which is to change the tooling that governs 80% of those sites.

**Henry Zhu**: Maybe you don't think that's an option because you have to interact with another project. Maybe a lot of the times we just observe the environment versus realizing we can act on it, meaning talk to people and work with them.

**Jason Miller**: I've run into this in the past where I pull a trace of something that I have source access and I can just change something in the source to affect the change that I need on that project. But in doing that, I'm limiting myself in terms of scope. It's O(1). If I can find a way to to go a level further or find the root cause, now I'm looking at O(n).
...
**Henry Zhu**: preset-env is like the evolution of what Babel was in the beginning. That's an artifact of showing why Babel is a transitional tool. Unlike every other language where you can just upgrade, although now that's not really a good assumption because of an example of like Python 2 to 3..

**Jason Miller**: We're almost there! 

**Henry Zhu**: We realized that upgrading is really hard, and maybe JavaScript is the language where it has to be that way. (video comes back) That jump from ES5 to ES6 was a big jump, but we're always going to have new features coming down the line. If you needed to use that feature, how would you choose to do it in the most efficient way possible? How does this tool help the whole community move forward? Right? Like first convincing people that this syntax is even worth using in the first place. 

**Jason Miller**: Maybe arriving at what that syntax would be. 

**Henry Zhu**: Oh yeah. Even beyond. So that's pre work, the whole Stage 0 process.
...
**Jason Miller**: How would you justify that investment?  

**Henry Zhu**: Versus anyone can just make a plugin and share it with people. And it doesn't have to be on NPM. One of my ideals is.. our REPL should somehow allow you to fork the parser in-line just to test out some syntax, share it on Twitter.

**Jason Miller**: I would love that, I mean we have the AST Explorer, which is something along those lines.

**Henry Zhu**: But at the syntax level.

**Jason Miller**: If it was like a checkbox. Oh God. 

**Henry Zhu**: That would be amazing. Like I want to just feel what it looks like to have two question marks for the optional chaining. I don't know. Like just to see it. Maybe it's a bad idea, but I think that's like where we all get into the theory.
...
**Jason Miller**: So instead of having discussions where we trade theories and ideals, we could have discussions where we trade prototypes. 

**Henry Zhu**: Right. Yeah. I guess that's a whole tangent (laughs).
...
**Jason Miller**: To me, the ideal for preset-env is always that percentage, right? Where it has a rough estimate of browser market share.
...
**Henry Zhu**: I didn't come up with the idea because I thought that the per browser and version idea made more sense to me because I was thinking from the program manager..

**Jason Miller**: your browser support matrix, right. 

**Henry Zhu**: They already have that, versus the percentage thing. No one thinks in that way.

**Jason Miller**: Makes sense. Percentage of what though? 

**Henry Zhu**: I guess now there are more browsers right. And some of them are based on Chrome, also in different countries.. there's mobile browsers. The matrix is already difficult, I guess that's the problem. 

**Jason Miller**: There's a weird permutation problem there, where if you say you want to support 98% of browsers, it might be that that means you could drop IE11 but support a bunch of very small market share browsers or you support all the smaller market share browsers and keep IE11. And really, if all you specify is a percentage, who decides that?

**Henry Zhu**: Right? It would be the browser list maintainers.

**Jason Miller**: Yes. But that's just like super arbitrary, 

**Henry Zhu**: Right.

**Jason Miller**: If you're deploying for enterprise in North America, it turns out you probably want to IE11. 

**Henry Zhu**: That gets into the issue of preset-env that we're going to talk about. There's just more that we don't know.
...
**Jason Miller**: Facebook's Webview.

**Henry Zhu**: Yeah, or IOT. How does that affect the support matrix level? 
...
**Jason Miller**: So we touched on one, which was you have browsers that are not evergreen, but that doesn't go away. The IE11s of the world.

**Henry Zhu**: Oh, so we have to explain the conservative approach of preset-env, which is..

**Jason Miller**: so supplying your browser versions.

**Henry Zhu**: meaning that when you make that list of versions, it does the least common denominator. 

**Jason Miller**: Right. Yeah. So Babel, can I make no assumption other than you will produce one set of JavaScript files. Because it is a tool that runs per module, right now. (laughs)

**Henry Zhu**: Right now. It makes sense that you would want to make multiple bundles based on which browser, like ideally every browser should have the optimized version. Assuming that's like the idealistic scenario where you don't have to worry about like caching or bugs in Babel. 

**Jason Miller**: Babel has no idea what your setup is. It's generally run as a tool is deeper in the chain than that.

**Henry Zhu**: So we just assume one build. 

**Jason Miller**: Yeah. So when you say, "I want to do a JavaScript bundle that supports current versions of Chrome, Firefox, Safari, and Edge, and IE11", you might as well just written IE11. Cause that's that's what the lowest common denominator is. 

**Henry Zhu**: Yeah. So that's just a thing that I decided that made sense, but it has certain implications. Your always stuck supporting you IE11, you don't take any advantages from that.

**Jason Miller**: That's if your browserslist never changes. The other one is if your browserslist does change or if you're doing bundles that support different grades of browser support.
...
**Henry Zhu**: Every line in your code is associated with some test or something.

**Jason Miller**: Yeah, literally. 

**Henry Zhu**: A bunch of if statements everywhere.

**Jason Miller**: And it seems like there'd be test coverage for 100% of a feature. Right. 

**Henry Zhu**: Which is why we have some reason to use test262 which is the official test. There are literally thousands of times. 

**Jason Miller**: If it passes test262, it's valid JavaScript.

**Henry Zhu**: But test262 is just tests by the committee and someone has to create them. They can actually miss tests. Some of our team members have actually added tests because they found something.

That's a whole scenario in itself. How do you come up with a test to test your language feature?

**Jason Miller**: Right, in the language.

**Henry Zhu**: I've talked to some people that work on it. Leo was saying they have generative tests, so they create code that will create more tests for them. Maybe that's an argument against adding syntax and why at the extreme level, lisp type stuff is good because it's just the parentheses, you create your macro system.

And then with us, every time you add a feature, you have to test against every other interaction with every other feature.

**Jason Miller**: Yeah, combinatorial.

**Henry Zhu**: So our tests become impossible instead of do.This is more inside baseball, but we use snapshot tests; we called them fixtures.
...
**Jason Miller**: This actually comes back to the problem that I kind of stumbled onto with preset-env.
...
**Henry Zhu**: So we need tests where you compile all the way down at every level in between. Ideally we have some sort of funding from companies that allows us to run all outputs for all browsers. 

**Jason Miller**: Every test262 tests in every preset-env configuration in every browser. And you can suck it back into preset-env and say, "I can guarantee that test262 passes with this configuration in Safari 10".

**Henry Zhu**: There's a lot of complexity, and it's like why we do even do this. (laughs)

**Jason Miller**: Yeah, there's lots of people out there who say, "Okay, this is the reason why we shouldn't transpile." Just just write code, and if browsers can't run it then that's their browsers fault.
...
**Henry Zhu**: The core question of Babel should be, am I allowed to write this syntax or when is it okay to write it? And it doesn't have to be, is it physically possible to do it in the browser? It might not be efficient, it's not optimized cause the browsers have to take time to implement and pass the tests, but then transpilers are faster.

**Jason Miller**: Right, which we've absolutely said in the past. Especially for a brand new syntax feature in a JavaScript engine, it's rarely going to have all the optimizations of the thing it is usurping.

**Henry Zhu**: Because the things that are optimized now are things that we've been writing for like five, ten years.

**Jason Miller**:  and they've been incentivized for optimization for those five to 10 writers.
...
**Henry Zhu**: So even if you don't transpile, the data that we get from transpiling actually helps everyone.

**Jason Miller**: We need the centralized knowledge of what works and what doesn't. It's more specific than just testing does a browser support arrow functions.

**Henry Zhu**: And what does it mean to support?

**Jason Miller**: Does it support them everywhere? (laughs)

**Henry Zhu**: Every scenario, or is it just the basic case or does it just pass the syntax? There's so many scenarios and even compat-table is just a simplified version. 

**Jason Miller**: It's a window into that. The weird one I'm thinking of is.. Edge 16 almost every test for functions you can think of, but if you define an arrow function, like const foo equals an arrow function, the .name property on that arrow function won't be foo, it will be undefined. And for the 99% case if you're a developer, you don't care. You're not using the name property.

**Henry Zhu**: What even is name?

**Jason Miller**: But then from Babel's perspective, do we bring in the arrow function transform?

**Henry Zhu**: So that's a scenario where I've always had this struggle.
We need a default. Then do we have options?

**Jason Miller**: Ahh, this is loose versus strict. Write in if you know what loose and strict mode means. You may be the only one! (laughs)

**Henry Zhu**: Is the default that we should output the simplest thing possible, because 99% of people will only write that code? Or should we be spec compliant because someone's going to write something weird, not weird, different, the 1% thing. Would be weird for them to be like, "Why is this not working?"

**Jason Miller**: If Babel said, "You can use arrow functions." And 99 people say, "Okay, that's cool. I can use my arrow functions as callbacks" and it works totally fine for them, but one person said, "No, it can't. They don't have a name property."

**Henry Zhu**: And that's in the spec or something.

**Jason Miller**: Or I'm running something on my code that optimizes all of my anonymous functions to arrow functions, and I'm relying on name somewhere. 

**Henry Zhu**: Right. Like minification or optimization. So how spec compliant should you be? You would think that should be a goal, but then also like there's certain tradeoffs, right?

**Jason Miller**: There's huge tradeoffs. One is you end up shoveling boatloads of code into people's bundles to fix problems they don't have, right. Because we don't know what problems they have. 

**Henry Zhu**: Are we okay with catering to the majority group, right? Or the more spec complaint thing. Maybe that's similar to the progressive enhancement versus a graceful degradation.

**Jason Miller**: It's almost like, you access the .name property, if there was somebody who could catch that and say, "Hey, turn on strict mode. We've got you covered."

**Henry Zhu**: That was another idea, how we should analyze the outport or how they use it and then Babel would be smart enough to suggest, "you can save this much space."

**Jason Miller**: The awkward thing here is true for a lot of AST based stuff. You probably wouldn't know from the AST that the.name property was being accessed on the function. The static analysis won’t be enough.
...
**Henry Zhu**: Then not knowing which one to lean toward you decide, “I'm going to go with (this is like most of life now), options.” You give everyone the freedom, the choice to do it, and then you realize that that's a really bad idea because no one wants to know. (laughs) No one knows the answer. They don't know what they want. And it's like people want you to choose for them in some sense.

**Jason Miller**: Especially for preset-env. We've said, give us your browserslist and we'll give you the code that works. And the options are essentially an admission that like, we can't. Unless everything is going to be installed by default and we're taking the trade off to one extreme, we can't commit to saying that this code will run in every browser. Because I don't think developers, if they were forced to make that decision, would make that call every time. I think they would go for a middle ground. I certainly do. I mean, I’m a loose mode user, just give me whatever's the smallest.

**Henry Zhu**: The general thing I would say was, if you're a library author you can probably confidently use loose mode, unlike if you're in the app, maybe not.

**Jason Miller**: If you constantly look at your output, by all means try loose mode and if it works, use it. Especially if you have error monitoring in place. It is an option that's there for a reason. Where that gets tricky is if you don't have good test coverage. 

**Henry Zhu**: Yeah. Because what happens is you use loose mode and that will turn off the transforms, but you were relying on the loose mode behavior, while the native versions are spec compliant.

**Jason Miller**: Yeah, you end up building code that only works when it's broken.

**Henry Zhu**: This gets me to think about optimization in general and is it worth it? You think about stuff like C compilers and how like the output has nothing to do with the input.
...
**Jason Miller**: Line 0, Character 65,010.

**Henry Zhu**: We need to make a judgment call on what kinds of optimization are worth it.
...
**Jason Miller**: Yeah, sacrificing debuggability in order to have optimizations is a tough call.

### How the problems was discovered

**Henry Zhu**: That's the implicit trade off that we don't think about. 
...
**Jason Miller**: Right. And it's difficult to bring the marketing along with that. The idea of preset-env, which is still largely intact, is it will open with the most minimal code possible for your browser support set. But with each quirky bug that gets reported, we get a little bit further from that goal.
...
**Jason Miller**: Yeah, so this is exactly where my journey with preset-modules started.
...
**Henry Zhu**: I don't even remember it. (laughs)

**Jason Miller**: Those are the ones that support modules and there's a convenient thing where you could have script type="module", take your modern script there and then script nomodule and stick your legacy script there. And you don't do any work, you just get loading for old browsers and new browsers. 

**Henry Zhu**: Because old browsers ignore the..

**Jason Miller**: it ignores nomodule. If it supports module, it ignores type=”module”.

**Henry Zhu**: So you have two script tags where one of them runs.

**Jason Miller**: And there's weird caveats to work around Safari, but by and large, this is the easiest way to do graded browser support, as long as you're okay with two grades. 

**Henry Zhu**: And that's kind of like a practical step instead of the whole matrix of every 

**Jason Miller**: browser user agent. 

**Henry Zhu**: Yeah figure out the user agent and then make a Babel compile for each one. So the thing that you found was that in some cases, nomodule/module, the two bundles were similar.

**Jason Miller**: I had cases where they were byte for byte identical. which was weird. We weren’t using const and let. I found that the absolute highest value transforms that preset-env could be dropping, like async-await, generators, tag templates (of which the modern version of those things are like super optimized, fast to parse, smaller, and compress better), I kept finding those were being compiled to ES5. Tagged templates were getting compiled to strings and function calls. Async-await was getting compiled to regenerator, which is quite high cost. This sort of kept coming up over and over.
...
**Henry Zhu**: There’s all these edge cases, and I don't remember them. When you hear stuff like that, you’re like, “That's weird, I don't really want to fix it, but that's a problem for them.” Maybe none of the team focused on it and someone else decided to fix it, and of course we'll just merge it in.
...
**Jason Miller**: Yeah. This is tag template call site tracking, and Safari 10 and 11 has two different weird bugs that get triggered at various States of optimization. But it's like, how would you test for that?
...
**Henry Zhu**: I think the general thing is just browsers have bugs.

**Jason Miller**: And that will always be the case. 

**Henry Zhu**: It's hard to acknowledge that. What are the implications of what that means?

**Jason Miller**: And each individual bug that gets reported is a small thing. And preset-env is actually really well designed in that it takes two seconds to change the data definition and recompile. It’s non-trivial, but it sort of buries the lead on that this is a huge de-optimization.

**Henry Zhu**: Because if it's Chrome 50 and now Chrome 49 and the config change is good, we don't see the input/output relationship when we change Babel that way.
...
**Jason Miller**: Yeah. So having sort of seen the bundles, I started to realize that we have sort of an out here. The bug is in a browser that has very good support for the syntax in question, except for in that one case.
**Jason Miller**: There's a bunch of cases I started to just catalog. As sort of like, “Oh, I found this thing.” There was only six really specific pain points that had been logged to Babel or discussed online.
...
**Jason Miller**: If it didn't use this the this keyword or touch arguments, it's almost identical.

**Henry Zhu**: So it's finding these little patches. You can picture making a bunch of plugins and maybe that could be a preset. So I think this whole thing is a very natural evolution of observing the environment, evaluating the results, and eventually telling us we should work on this.

**Jason Miller**: I understand preset-env here. It's just difficult if you've been working in the model the preset-env enabled to take a step back and say, “wait, could we do patching?” Is this completely different approach something we can incorporate when you have so much great infrastructure setup around that exact way of doing the conditional down leveling. 

**Henry Zhu**: When I saw those issues, I was just like, “how do we fix this?”

**Jason Miller**: Right. Do you fix it by starting a fundamentally new project? Probably not. (laughs)

**Henry Zhu**: So this is what that is, preset-modules. We had a discussion on the name which was difficult.

**Jason Miller**: That’s why we keep getting it wrong, 

**Henry Zhu**: Because then I think the first thing would be, “Oh, it compiles modules!” 

**Jason Miller**: Yeah. It doesn't, has nothing to do with module. 

**Henry Zhu**: It has something to do with ES modules. 

**Jason Miller**: There's no modules transforms. 

**Henry Zhu**: Oh yeah, we were going to call it babel-preset-fix-browser-bugs or something like that. (laughs)

**Jason Miller**: Try and go as literal as humanly possible. Like an Apple length method name. 

### preset-modules is Temporary

**Henry Zhu**: I think the fact that it's really hard to come up with a name shows that this doesn't need to be a thing. I think we already described the preset, it's a bunch of bug fixes in the form of Babel plugins that transform the code in a way that isn't the whole transform. It's like the smallest possible change to fix the browser bug.

**Jason Miller**: There's a transform to fix the function .name property, there’s a transform to fix the tag templates tracking. If you just look at the transform names, it's fix-transform-tagged-template-caching. They are laser-focused fixes. And you compare that to the transform names in preset-env, which is like transform tagged-templates?
...
**Henry Zhu**: This is just a snapshot in time. Preset-env was supposed to be for Babel a way to transition as well. It’s not really that this preset is what matters. The idea behind it and how to somehow integrate this back into Babel itself, which in this case is just preset-env. What we decided is that we want people to get the benefits now and get feedback. We need to figure out how to patch preset-env. 

**Jason Miller**: You and I have talked about those browser support cliffs that we have crossed. The ES modules browser support target remains a pretty good one because that's a pretty modern set of browsers, right? You're talking 80% percent market share and fairly recent browsers.
...
**Henry Zhu**: What we're asking for now is a process change for Babel to add these things. I thought that was like what jQuery was doing to. People talked about querySelector, but it also fixed browser bugs, right? And it gave you this API that it just works across all browsers. We're doing that with syntax.

**Jason Miller**: For Babel, the key there would be, it needs to be such that if you're using preset-env you define your browser support target to be Safari 12+, you shouldn't get the tag templates transform. We want it to be there by default, when you need it, but not when you don’t.

**Henry Zhu**: I think that's a good explanation. How would you describe this scenario all the way down, right? There's a whole path: the proposal for the future, it gets standardized, it gets implemented in Babel, it gets into the browser, and then there's a bug in the browser. The browser bug could have been reported to the browser directly. Eventually someone points it to us and then we have to create the patch. How does that work? Right now everything is just so ad hoc.

**Jason Miller**: My list of bugs was a mix of WebKit tracker, Chrome tracker, and Babel issues. Very few of them had both. Which was interesting because at some point it doesn't matter what happens, somebody who needs to know about this isn't going to.
...
**Henry Zhu**: Either coordination effort, not that we need to make our own compat table. We do have a real reason to do that, in the interest of our project. I thought for a lot of people, the compat-table was just like a nice thing to look at it. But for us it's literally the data to make this work.  

**Jason Miller**: It’s what you what of written as code.

**Henry Zhu**: It is code for us. For other people, it's okay if it's kind of wrong.

**Jason Miller**: For Babel’s purposes, you could make an argument that it would be nice to have that data in-house so that it can be mutated when fixes are produced.

**Henry Zhu**: At least in a way that we can manipulate. I would love to not maintain more stuff or have to recreate anything either. Can we work together to do that kind of thing? 

**Jason Miller**: And then you're bringing in the whole test262. Does Babel do the work of meshing all this data together or do we just need a centralized place for this data? Cause there's also the reporting aspect. I'm a developer using Babel, it might be the most logical place for me to go and file a bug. But then does Babel go a file a bug with the browser engine?

**Henry Zhu**: Or do you make a bot that does it?

**Jason Miller**: Who's maintaining that infrastructure?

### A Call for Feedback and Teaser

**Henry Zhu**: I think that basically covers it. Maybe you can mention this first bullet point?

**Jason Miller**: So we published Babel preset-modules as its own independent thing. You're going to install it on npm, some products are already using it.
...
**Henry Zhu**: What projects are you using it now? 

**Jason Miller**: Next.js ships it, which is pretty cool. 

**Henry Zhu**: I did post on Twitter if people had things we should talk about. We can mention them and maybe they can be future episodes because it's a whole different topic. Vincent and a lot of other people were asking about compiling node_modules, so yeah.

**Jason Miller**: Something, something, try running Babel on your output. Maybe topic for a second episode. 
...
**Henry Zhu**: I think you've written like at least two or three blog posts on the topic, and I wrote one a long time ago. 

**Jason Miller**: Those are just the public blog posts. You should see this stuff. I've pitched it people internally. 

**Henry Zhu**: How do we get library authors to.. so all the problems we're talking about now are your own code.
...
**Jason Miller**: What if it's too late, right? (laughs) Like quite literally. What if all the code that you're passing to Babel is already transpired to ES5. Does anything matter?

**Henry Zhu**: Why are you even worrying about your own code? That's a good teaser for the next 

**Jason Miller**: Find out next, on the Babel podcast!

**Henry Zhu**: Yeah. I think that's good then.
